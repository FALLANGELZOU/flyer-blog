              ...
              <div style={{
                ...
                <div style={{marginBottom:'24px'}}>
                  <Space wrap direction="horizontal" size={16}>
                    <Github style={{width:'48rem'}}/>
                    <QQ style={{width:'48rem'}}/>
                    <WX style={{width:'48rem'}}/>
                  </Space>
                </div>
              </div>
